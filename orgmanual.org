...
error occurred.  Here is how to produce a useful backtrace:
  ...
  1. Reload uncompiled versions of all Org mode Lisp files.  The
     ...
     uncompiled code. To do this, use @@info:@kbd{@@C-u M-x org-reload@@info:@key{@@RET@@info:}@@@@info:}@@ or select ~Org -> Refresh/Reload -> Reload Org
...
#+attr_texinfo: :table-type "table" :indic "@asis"
  - @@info:@key{@@TAB@@info:}@@ ~org-cycle~ :: Items can be folded just like
       ...
       initial position. @@info:@cindex cycling, in plain lists@@

       @@info:@kindex TAB@@
       @@info:@findex org-cycle@@
       @@info:@vindex org-cycle-include-plain-lists@@       
  - @@info:@kbd{@@M-@@info:@key{@@RET@@info:}@@@@info:}@@ ~org-insert-heading~ :: Insert new item at
       ...
       @@info:@vindex org-M-RET-may-split-line@@
       @@info:@vindex org-list-automatic-rules@@
  - @@info:@kbd{@@M-S-@@info:@key{@@RET@@info:}@@@@info:}@@ :: Insert a new item with a checkbox (see
       Checkboxes).
...
** Blocks
   ...
   :END:
@@info:@vindex org-hide-block-startup@@ @@info:@cindex blocks, folding@@
...
footnote, use the {{{latex}}} idiom @@info:@samp{@@\par@@info:}@@. The
...
#+attr_texinfo: :table-type "table" :indic "@kbd"
  ...
  - C-c C-c :: If the cursor is on a footnote reference, jump to the
               ...
               a prefix argument, offer the same menu as @@info:@kbd{@@C-c
               C-x f@@info:}@@.
...
makes this possible.  Toggle the mode with @@info:@kbd{@@M-x
orgstruct-mode@@info:}@@, or turn it on by default, for example in Message
mode, with one of:
...
- @@info:@kbd{@@M-@@info:@key{@@up@@info:}@@@@info:}@@ ~org-table-move-row-up~ ::
     @@info:@itemx@@ @@info:@kbd{@@M-down@@info:@key{@@@@info:}@@@@info:}@@ ~org-table-move-row-down~
...
#+attr_texinfo: :table-type "table" :indic "@samp"
  ...
  - * :: Selects this line for global recalculation with @@info:@kbd{@@C-u
         C-c *@@info:}@@, but not for automatic recalculation.  Use this
         when automatic recalculation slows down editing too much.
  - :: Unmarked lines are exempt from recalculation with @@info:@kbd{@@C-u
       C-c *@@info:}@@.  All lines that should be recalculated should be
...
the link text. In the above example the search would be for @@info:@samp{@@my
target@@info:}@@.
...
@@info:@samp{@@<<<My Target>>>@@info:}@@ causes each occurrence of @@info:@samp{@@my
target@@info:}@@ in normal text to become activated as a link.  The Org file
...
#+attr_texinfo: :table-type "table" :indic "@asis"
  ...
  - @@info:@kbd{@@C-c C-l@@info:}@@ (with cursor on existing link) :: When the
    ...
    - @@info:@key{@@mouse-2@@info:}@@ or @@info:@key{@@mouse-1@@info:}@@ :: On links,
         @@info:@kbd{@@mouse-2@@info:}@@ will open the link just as @@info:@kbd{@@C-c
         C-o@@info:}@@ would. Under Emacs 22 and later, @@info:@kbd{@@mouse-1@@info:}@@
    ...
    - @@info:@kbd{@@C-c &@@info:}@@ ~org-mark-ring-goto~ ::
         ...
         the commands following internal links, and by @@info:@kbd{@@C-c
         %@@info:}@@. Using this command several times in direct succession
...
- @item My Target :: Search for a link target @@info:@samp{@@<<My
     Target>>@@info:}@@, or do a text search for @@info:@samp{@@my target@@info:}@@,
...
- @@info:@kbd{@@S-M-@key{RET}@@info:}@@ ~org-insert-todo-heading~ ::
...
of the DONE states, a line @@info:@samp{@@CLOSED: [timestamp]@@info:}@@ will be inserted
...
the entry with a @@info:@samp{@@Closing Note@@info:}@@ heading.

In the timeline (see [[Timeline]]) and in the agenda
(see [[Weekly/daily agenda]]), you can then use the @@info:@kbd{@@l@@info:}@@ key to
display the TODO items with a @@info:@samp{@@CLOSED@@info:}@@ timestamp on each day,
...
- @@info:@kbd{@@M-S-@key{RET}@@info:}@@ ~org-insert-todo-heading~ :: Insert a new
...
@@info:@samp{@@XXXn@@info:}@@ into the tag list
...
with just the following keys: @@info:@kbd{@@C-c C-c @key{SPC} h l p
@key{RET}@@info:}@@}. Switching from @@info:@samp{@@@@home@@info:}@@ to
...
tag @@info:@samp{@@Sarah@@info:}@@ could be done with @@info:@kbd{@@C-c C-c @key{TAB} S a
r a h @key{RET} @key{RET}@@info:}@@.
...
#+attr_texinfo: :table-type "table" :indic "@asis"
- @@info:@kbd{@@C-c / m@@info:}@@ {{{kbd(C-c \\)}}} ~org-match-sparse-tree~ ::
...
- ~:hlines~ ::
  ...
  {{{var(N)}}}, insert an hline before each headline with level ~<= @var{N}~.
...
* FIXME Capture - Refile - Archive                                 :noexport:
  :PROPERTIES:
...
a line break within a paragraph, use {{{samp(XXX\\\)}}} at the end of a line.
...
{{{samp(#+BEGIN_SRC pascal -n -r -l "((%s))")}}}.  See also the variable ~org-coderef-label-format~.
...
than 30 stars. This is a hardcoded limitation of {{{var(lmax)}}} in
~org-clock-sum~.
