...
* FIXME Working with source code                                   :noexport:
  :PROPERTIES:
...
- *Language* @tab *Identifier* @tab *Language* @tab *Identifier*
...
- *Default* @tab *Alternative 1* @tab *Speed key* @tab *Alternative 2*
