...
have a @emph{deadline} (see [[Timestamps]]) as no longer @emph{open}.
...
If headlines in the agenda files are marked with @emph{tags} (see [[Tags]]),
...
with a @emph{prefix} that contains the @emph{category} (see [[Categories]])
...
~#+ATTR_ODT~ line.  @xref{Customizing tables in ODT export}.
...
~#+CAPTION~ lines.  @xref{Images and tables}.  ODT exporter enumerates
...
@item ~:link-up~               @tab ~org-export-html-link-up~
@item ~:link-home~             @tab ~org-export-html-link-home~
@item ~:language~              @tab ~org-export-default-language~
@item ~:customtime~            @tab ~org-display-custom-times~
@item ~:headline-levels~       @tab ~org-export-headline-levels~
@item ~:section-numbers~       @tab ~org-export-with-section-numbers~
@item ~:section-number-format~ @tab ~org-export-section-number-format~
@item ~:table-of-contents~     @tab ~org-export-with-toc~
@item ~:preserve-breaks~       @tab ~org-export-preserve-breaks~
@item ~:archived-trees~        @tab ~org-export-with-archived-trees~
@item ~:emphasize~             @tab ~org-export-with-emphasize~
@item ~:sub-superscript~       @tab ~org-export-with-sub-superscripts~
@item ~:special-strings~       @tab ~org-export-with-special-strings~
@item ~:footnotes~             @tab ~org-export-with-footnotes~
@item ~:drawers~               @tab ~org-export-with-drawers~
@item ~:tags~                  @tab ~org-export-with-tags~
@item ~:todo-keywords~         @tab ~org-export-with-todo-keywords~
@item ~:tasks~                 @tab ~org-export-with-tasks~
@item ~:priority~              @tab ~org-export-with-priority~
@item ~:TeX-macros~            @tab ~org-export-with-TeX-macros~
@item ~:LaTeX-fragments~       @tab ~org-export-with-LaTeX-fragments~
@item ~:latex-listings~        @tab ~org-export-latex-listings~
@item ~:skip-before-1st-heading~ @tab ~org-export-skip-text-before-1st-heading~
@item ~:fixed-width~           @tab ~org-export-with-fixed-width~
@item ~:timestamps~            @tab ~org-export-with-timestamps~
@item ~:author~                @tab ~user-full-name~
@item ~:email~                 @tab ~user-mail-address~ : ~addr;addr;..~
@item ~:author-info~           @tab ~org-export-author-info~
@item ~:email-info~            @tab ~org-export-email-info~
@item ~:creator-info~          @tab ~org-export-creator-info~
@item ~:tables~                @tab ~org-export-with-tables~
@item ~:table-auto-headline~   @tab ~org-export-highlight-first-table-line~
@item ~:style-include-default~ @tab ~org-export-html-style-include-default~
@item ~:style-include-scripts~ @tab ~org-export-html-style-include-scripts~
@item ~:style~                 @tab ~org-export-html-style~
@item ~:style-extra~           @tab ~org-export-html-style-extra~
@item ~:convert-org-links~     @tab ~org-export-html-link-org-files-as-html~
@item ~:inline-images~         @tab ~org-export-html-inline-images~
@item ~:html-extension~        @tab ~org-export-html-extension~
@item ~:html-preamble~         @tab ~org-export-html-preamble~
@item ~:html-postamble~        @tab ~org-export-html-postamble~
@item ~:xml-declaration~       @tab ~org-export-html-xml-declaration~
@item ~:html-table-tag~        @tab ~org-export-html-table-tag~
@item ~:expand-quoted-html~    @tab ~org-export-html-expand~
@item ~:timestamp~             @tab ~org-export-html-with-timestamp~
@item ~:publishing-directory~  @tab ~org-export-publishing-directory~
@item ~:select-tags~           @tab ~org-export-select-tags~
@item ~:exclude-tags~          @tab ~org-export-exclude-tags~
@item ~:latex-image-options~   @tab ~org-export-latex-image-default-option~
@end multitable
...
@item ~:sitemap-ignore-case~
@tab Should sorting be case-sensitive?  Default ~nil~.

@item ~:sitemap-file-entry-format~
...
information on the structure of ~#+CALL:~ lines see @ref{Evaluating code
blocks}.
...
~[[file:]]~ link (see @ref{Link format}) to the file will be inserted
...
(see @ref{Link format}).  If the ~:file-desc~ header argument is given
...
links inserted into the buffer will @emph{not} be expanded against ~default
...
specified with ~:var~ (see @ref{var}), and of replacing ``noweb''
...
to be turned on for the ~noweb-ref~ property, see @ref{Property
inheritance}).}.
...
The ~:noweb-sep~ (see @ref{noweb-sep}) header argument holds the string
...
of the ~org-confirm-babel-evaluate~ variable see @ref{Code evaluation
security}.
...
@item ~:results value~ @tab value of last expression @tab value of last expression
@item ~:results output~ @tab contents of STDOUT @tab concatenation of interpreter output
@end multitable
...
{{{kindex(C-up)}}}
@item {{{kbdkey(C-,up)}}}    @tab ~org-babel-load-in-session~
{{{kindex(M-down)}}}
@item {{{kbdkey(M-,down)}}}  @tab ~org-babel-pop-to-session~
@end multitable
...
{{{kindex(C-c C-v p)}}}
{{{kindex(C-c C-v C-p)}}}
@item {{{kbd(C-c C-v p)}}} @ @ @r{or} @ @ {{{kbd(C-c C-v C-p)}}} @tab ~org-babel-previous-src-block~
{{{kindex(C-c C-v n)}}}
{{{kindex(C-c C-v C-n)}}}
@item {{{kbd(C-c C-v n)}}} @ @ @r{or} @ @ {{{kbd(C-c C-v C-n)}}} @tab ~org-babel-next-src-block~
{{{kindex(C-c C-v e)}}}
{{{kindex(C-c C-v C-e)}}}
@item {{{kbd(C-c C-v e)}}} @ @ @r{or} @ @ {{{kbd(C-c C-v C-e)}}} @tab ~org-babel-execute-maybe~
{{{kindex(C-c C-v o)}}}
{{{kindex(C-c C-v C-o)}}}
@item {{{kbd(C-c C-v o)}}} @ @ @r{or} @ @ {{{kbd(C-c C-v C-o)}}} @tab ~org-babel-open-src-block-result~
{{{kindex(C-c C-v v)}}}
{{{kindex(C-c C-v C-v)}}}
@item {{{kbd(C-c C-v v)}}} @ @ @r{or} @ @ {{{kbd(C-c C-v C-v)}}} @tab ~org-babel-expand-src-block~
{{{kindex(C-c C-v u)}}}
{{{kindex(C-c C-v C-u)}}}
@item {{{kbd(C-c C-v u)}}} @ @ @r{or} @ @ {{{kbd(C-c C-v C-u)}}} @tab ~org-babel-goto-src-block-head~
{{{kindex(C-c C-v g)}}}
{{{kindex(C-c C-v C-g)}}}
@item {{{kbd(C-c C-v g)}}} @ @ @r{or} @ @ {{{kbd(C-c C-v C-g)}}} @tab ~org-babel-goto-named-src-block~
{{{kindex(C-c C-v r)}}}
{{{kindex(C-c C-v C-r)}}}
@item {{{kbd(C-c C-v r)}}} @ @ @r{or} @ @ {{{kbd(C-c C-v C-r)}}} @tab ~org-babel-goto-named-result~
{{{kindex(C-c C-v b)}}}
{{{kindex(C-c C-v C-b)}}}
...
{{{kindex(C-c C-v d)}}}
{{{kindex(C-c C-v C-d)}}}
@item {{{kbd(C-c C-v d)}}} @ @ @r{or} @ @ {{{kbd(C-c C-v C-d)}}} @tab ~org-babel-demarcate-block~
{{{kindex(C-c C-v t)}}}
{{{kindex(C-c C-v C-t)}}}
...
{{{kindex(C-c C-v c)}}}
{{{kindex(C-c C-v C-c)}}}
@item {{{kbd(C-c C-v c)}}} @ @ @r{or} @ @ {{{kbd(C-c C-v C-c)}}} @tab ~org-babel-check-src-block~
{{{kindex(C-c C-v j)}}}
{{{kindex(C-c C-v C-j)}}}
@item {{{kbd(C-c C-v j)}}} @ @ @r{or} @ @ {{{kbd(C-c C-v C-j)}}} @tab ~org-babel-insert-header-arg~
{{{kindex(C-c C-v l)}}}
{{{kindex(C-c C-v C-l)}}}
@item {{{kbd(C-c C-v l)}}} @ @ @r{or} @ @ {{{kbd(C-c C-v C-l)}}} @tab ~org-babel-load-in-session~
{{{kindex(C-c C-v i)}}}
{{{kindex(C-c C-v C-i)}}}
@item {{{kbd(C-c C-v i)}}} @ @ @r{or} @ @ {{{kbd(C-c C-v C-i)}}} @tab ~org-babel-lob-ingest~
{{{kindex(C-c C-v I)}}}
{{{kindex(C-c C-v C-I)}}}
@item {{{kbd(C-c C-v I)}}} @ @ @r{or} @ @ {{{kbd(C-c C-v C-I)}}} @tab ~org-babel-view-src-block-info~
{{{kindex(C-c C-v z)}}}
{{{kindex(C-c C-v C-z)}}}
@item {{{kbd(C-c C-v z)}}} @ @ @r{or} @ @ {{{kbd(C-c C-v C-z)}}} @tab ~org-babel-switch-to-session-with-code~
{{{kindex(C-c C-v a)}}}
{{{kindex(C-c C-v C-a)}}}
@item {{{kbd(C-c C-v a)}}} @ @ @r{or} @ @ {{{kbd(C-c C-v C-a)}}} @tab ~org-babel-sha1-hash~
{{{kindex(C-c C-v h)}}}
{{{kindex(C-c C-v C-h)}}}
@item {{{kbd(C-c C-v h)}}} @ @ @r{or} @ @ {{{kbd(C-c C-v C-h)}}} @tab ~org-babel-describe-bindings~
{{{kindex(C-c C-v x)}}}
{{{kindex(C-c C-v C-x)}}}
@item {{{kbd(C-c C-v x)}}} @ @ @r{or} @ @ {{{kbd(C-c C-v C-x)}}} @tab ~org-babel-do-key-sequence-in-edit-buffer~
@end multitable
...
@item {{{kbd(s)}}} @tab ~#+BEGIN_SRC     ... #+END_SRC~
@item {{{kbd(e)}}} @tab ~#+BEGIN_EXAMPLE ... #+END_EXAMPLE~
@item {{{kbd(q)}}} @tab ~#+BEGIN_QUOTE   ... #+END_QUOTE~
@item {{{kbd(v)}}} @tab ~#+BEGIN_VERSE   ... #+END_VERSE~
@item {{{kbd(c)}}} @tab ~#+BEGIN_CENTER  ... #+END_CENTER~
@item {{{kbd(l)}}} @tab ~#+BEGIN_LaTeX   ... #+END_LaTeX~
@item {{{kbd(L)}}} @tab ~#+LaTeX:~
@item {{{kbd(h)}}} @tab ~#+BEGIN_HTML    ... #+END_HTML~
@item {{{kbd(H)}}} @tab ~#+HTML:~
@item {{{kbd(a)}}} @tab ~#+BEGIN_ASCII   ... #+END_ASCII~
@item {{{kbd(A)}}} @tab ~#+ASCII:~
@item {{{kbd(i)}}} @tab ~#+INDEX:~ line
@item {{{kbd(I)}}} @tab ~#+INCLUDE:~ line
@end multitable
...
@item Following ~shell~ and ~elisp~ links
...
this key is to add @emph{tags} to a headline (see [[Tags]]).  In many
...
@item {{{kbdkey(S-,TAB)}}}     @tab {{{kbdkey(C-u ,TAB)}}}       @tab {{{kbd(C)}}} @tab
@item {{{kbdkey(M-,left)}}}    @tab {{{kbd(C-c C-x l)}}}           @tab {{{kbd(l)}}} @tab @kbd{@key{Esc} @key{left}}
@item {{{kbdkey(M-S-,left)}}}  @tab {{{kbd(C-c C-x L)}}}           @tab {{{kbd(L)}}} @tab
@item {{{kbdkey(M-,right)}}}   @tab {{{kbd(C-c C-x r)}}}           @tab {{{kbd(r)}}} @tab @kbd{@key{Esc} @key{right}}
@item {{{kbdkey(M-S-,right)}}} @tab {{{kbd(C-c C-x R)}}}           @tab {{{kbd(R)}}} @tab
@item {{{kbdkey(M-,up)}}}      @tab {{{kbd(C-c C-x u)}}}           @tab {{{kbd( )}}} @tab @kbd{@key{Esc} @key{up}}
@item {{{kbdkey(M-S-,up)}}}    @tab {{{kbd(C-c C-x U)}}}           @tab {{{kbd(U)}}} @tab
@item {{{kbdkey(M-,down)}}}    @tab {{{kbd(C-c C-x d)}}}           @tab {{{kbd( )}}} @tab @kbd{@key{Esc} @key{down}}
@item {{{kbdkey(M-S-,down)}}}  @tab {{{kbd(C-c C-x D)}}}           @tab {{{kbd(D)}}} @tab
@item {{{kbdkey(S-,RET)}}}     @tab {{{kbd(C-c C-x c)}}}           @tab {{{kbd( )}}} @tab
@item {{{kbdkey(M-,RET)}}}     @tab {{{kbd(C-c C-x m)}}}           @tab {{{kbd( )}}} @tab @kbd{@key{Esc} @key{RET}}
@item {{{kbdkey(M-S-,RET)}}}   @tab {{{kbd(C-c C-x M)}}}           @tab {{{kbd( )}}} @tab
@item {{{kbdkey(S-,left)}}}    @tab {{{kbdkey(C-c ,left)}}}      @tab {{{kbd( )}}} @tab
@item {{{kbdkey(S-,right)}}}   @tab {{{kbdkey(C-c ,right)}}}     @tab {{{kbd( )}}} @tab
@item {{{kbdkey(S-,up)}}}      @tab {{{kbdkey(C-c ,up)}}}        @tab {{{kbd( )}}} @tab
@item {{{kbdkey(S-,down)}}}    @tab {{{kbdkey(C-c ,down)}}}      @tab {{{kbd( )}}} @tab
@item {{{kbdkey(C-S-,left)}}}  @tab {{{kbdkey(C-c C-x ,left)}}}  @tab {{{kbd( )}}} @tab
@item {{{kbdkey(C-S-,right)}}} @tab {{{kbdkey(C-c C-x ,right)}}} @tab {{{kbd( )}}} @tab
@end multitable
