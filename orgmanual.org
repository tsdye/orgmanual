...
- :lang ::        
  ...
  Language to use for descriptive cells like "Task".[fn:90]
...
{{{noindent}}} To use a specific time range you could write:[fn:83]
...
- f  :: 
  ...
  Apply a function to marked entries.[fn:192] For example, the function
...
- #+DATE: ::       
  ...
  A date, an Org timestamp, or a format string for ~format-time-string~.[fn:179]
...
[fn:1] DEFINITION NOT FOUND: fn:1
...
[fn:90] Language terms can be set through the variable
...
[fn:192] You can also create persistent custom functions through
